<template>
  <v-row class="fill-height">
    <v-col>
      <v-sheet height="64">
        <v-toolbar flat>
          <v-btn text @click="type = 'month'">
            <v-icon >mdi-dialpad</v-icon>
          </v-btn>
          <v-btn outlined class="mr-4" color="grey darken-2" @click="setToday">
            Today
          </v-btn>
          <v-btn outlined class="mr-4" color="grey darken-2" @click.stop="dialogDate = true">
            New event
          </v-btn>
...
<v-dialog v-model="dialogDate" max-width="500">
  <v-card>
    <v-container>
      <v-form @submit.prevent="addEvent" style="padding-bottom: 1em;">
      ...
      <v-btn type="submit" color="light" class="mr-4" @click.stop="dialogDate = false">
          Cancel
      </v-btn>
    </v-container>
  </v-card>
